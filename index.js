...
(function($PS) {
  ...
  "use strict";
  $PS["WebGLMandelbrot.Mandelbrot"] = $PS["WebGLMandelbrot.Mandelbrot"] || {};
  var exports = $PS["WebGLMandelbrot.Mandelbrot"];
  var $foreign = $PS["WebGLMandelbrot.Mandelbrot"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Functor = $PS["Data.Functor"];
...
(function($PS) {
  ...
  var WebGLMandelbrot_Mandelbrot = $PS["WebGLMandelbrot.Mandelbrot"];                
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(WebGLMandelbrot_Mandelbrot.component)(Data_Unit.unit)(body);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();