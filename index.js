      ...
      return function (v1) {
          return Halogen_Hooks_Hook.discard(Halogen_Hooks.useLifecycleEffect(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(Effect_Aff.monadEffectAff))(function __do() {
              ...
              return Halogen_Hooks_Hook.bind(Data_Functor.map(Halogen_Hooks_Hook.functorHook)(Data_Maybe.fromMaybe({
                  ...
                  }) ])([  ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("left: 40px; bottom: 10px; font-size: 15px; font-family: 'Montserrat', sans-serif; position: absolute; width: auto; height: 50px; display: flex; align-items: center; justify-content: center;") ])([ Halogen_HTML_Core.text("YUKIWORKS"), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("https://yukikurage.github.io/portfolio/"), Halogen_HTML_Properties.style("position:absolute; width: 100%; height: 100%; left: 0; top: 0;"), Halogen_HTML_Properties.target("_blank"), Halogen_HTML_Properties.rel("noopener") ])([  ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("left: 40px; top: 10px; font-size: 20px; font-family: 'Montserrat', sans-serif; position: absolute; width: auto; height: 50px; display: flex; align-items: center; justify-content: center;") ])([ Halogen_HTML_Core.text("MANDELBROT") ]) ]));
              });
          });
      };
  });
