...
(function($PS) {
  ...
  var functorHook = {
      map: function (f) {
          return function (m) {
              return Data_Functor.map(Control_Monad_Free.freeFunctor)(f)(m);
          };
      }
  };
  var bind = function (v) {
  ...
  exports["functorHook"] = functorHook;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
...
})(PS["Mandelbrot.Mandelbrot"] = PS["Mandelbrot.Mandelbrot"] || {});
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["Mandelbrot.Hooks.UseWindowSize"] = $PS["Mandelbrot.Hooks.UseWindowSize"] || {};
  var exports = $PS["Mandelbrot.Hooks.UseWindowSize"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var Web_HTML = $PS["Web.HTML"];
  var Web_HTML_Window = $PS["Web.HTML.Window"];                
  var useWindowSize = function (dictMonadAff) {
      var subscribe = function (setSize) {
          var readSize = function (win) {
              return Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(dictMonadAff.MonadEffect0()))(Web_HTML_Window.innerWidth(win)))(function (w) {
                  return Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(dictMonadAff.MonadEffect0()))(Web_HTML_Window.innerHeight(win)))(function (h) {
                      return setSize(new Data_Maybe.Just({
                          width: w,
                          height: h
                      }));
                  });
          ...
          return Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(dictMonadAff.MonadEffect0()))(Web_HTML.window))(function (window) {
              return Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.subscribe(Halogen_Query_Event.eventListener("resize")(Web_HTML_Window.toEventTarget(window))(Control_Bind.composeKleisli(Data_Maybe.bindMaybe)(Web_Event_Event.target)((function () {
                  var $5 = Data_Functor.map(Data_Maybe.functorMaybe)(readSize);
                  return function ($6) {
                      return $5(Web_HTML_Window.fromEventTarget($6));
                  };
              })()))))(function (subscriptionId) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(readSize(window))(function () {
                      return Control_Applicative.pure(Halogen_Hooks_HookM.applicativeHookM)(subscriptionId);
                  });
              });
          });
      };
      return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(Data_Maybe.Nothing.value))(function (v) {
          return Halogen_Hooks_Hook.discard(Halogen_Hooks.useLifecycleEffect(Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(subscribe(Halogen_Hooks_HookM.put(v.value1)))(function (subscription) {
...
(function($PS) {
  ...
  "use strict";
  $PS["Mandelbrot.Mandelbrot"] = $PS["Mandelbrot.Mandelbrot"] || {};
  var exports = $PS["Mandelbrot.Mandelbrot"];
  var $foreign = $PS["Mandelbrot.Mandelbrot"];
  var Color = $PS["Color"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var DOM_HTML_Indexed_InputType = $PS["DOM.HTML.Indexed.InputType"];
  ...
  var Halogen_Hooks_Hook = $PS["Halogen.Hooks.Hook"];
  var Halogen_Hooks_HookM = $PS["Halogen.Hooks.HookM"];
  var Mandelbrot_Hooks_UseWindowSize = $PS["Mandelbrot.Hooks.UseWindowSize"];
  var Web_Event_Event = $PS["Web.Event.Event"];
  var Web_HTML_HTMLInputElement = $PS["Web.HTML.HTMLInputElement"];                
  var toColorData = function (col) {
      var c = Color.toHSVA(col);
      return {
          h: c.h / 360.0,
          s: c.s,
          v: c.v
  ...
  var makeColorSetter = function (setter) {
      return function (val) {
          return function (tex) {
              return function (id) {
                  return function (color) {
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("display: flex; flex-direction: row; align-items: center;") ])([ Halogen_HTML_Elements.div([  ])([  ]), Halogen_HTML_Core.text(tex), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.style("margin: 10px 10px 10px 10px; inherit; background-color:rgba(255,255,255,0); border: 0px solid; font-family: 'Montserrat', sans-serif; font-size: 18px;"), Halogen_HTML_Properties.value(val), Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputColor.value), Halogen_HTML_Events.onInput(function (e) {
                          return Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(Effect_Aff.monadEffectAff))((function () {
                              var input = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Web_HTML_HTMLInputElement.fromEventTarget)(Web_Event_Event.currentTarget(e));
                              return function __do() {
                                  var colText = Data_Traversable.sequence(Data_Traversable.traversableMaybe)(Effect.applicativeEffect)(Data_Functor.map(Data_Maybe.functorMaybe)(Web_HTML_HTMLInputElement.value)(input))();
                                  var col = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Color.fromHexString)(colText);
                                  Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit))(function ($15) {
                                      return setter(toColorData($15));
                                  })(col)();
                                  return col;
                              };
                          })()))(function (col) {
                              return Data_Maybe.maybe(Control_Applicative.pure(Halogen_Hooks_HookM.applicativeHookM)(Data_Unit.unit))(Halogen_Hooks_HookM.put(id))(col);
                          });
                      }) ]) ]);
                  };
              };
  ...
  var component = Halogen_Hooks_Component.component(function (v) {
      return function (v1) {
          return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(Color["rgb'"](1.0)(1.0)(1.0)))(function (v2) {
              return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(Color["rgb'"](1.0)(1.0)(1.0)))(function (v3) {
                  return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(Color["rgb'"](0.0)(0.0)(0.0)))(function (v4) {
                      return Halogen_Hooks_Hook.discard(Halogen_Hooks.useLifecycleEffect(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(Effect_Aff.monadEffectAff))(function __do() {
                          var canvas = Control_Bind.bindFlipped(Effect.bindEffect)(Data_Maybe.maybe(Effect_Exception["throw"]("canvas\u8981\u7d20\u304c\u53d6\u5f97\u3067\u304d\u307e\u305b\u3093\u3067\u3057\u305f"))(Control_Applicative.pure(Effect.applicativeEffect)))(Graphics_Canvas.getCanvasElementById("canvas"))();
                          return $foreign.drawMandelbrot(canvas)();
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Hooks_HookM.applicativeHookM)(Data_Maybe.Nothing.value);
                      })))(function () {
                          return Halogen_Hooks_Hook.bind(Data_Functor.map(Halogen_Hooks_Hook.functorHook)(Data_Maybe.fromMaybe({
                              width: 640,
                              height: 640
                          }))(Mandelbrot_Hooks_UseWindowSize.useWindowSize(Effect_Aff_Class.monadAffAff)))(function (windowSize) {
                              return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("width: 100vw; height: 100vh; position: relative;") ])([ Halogen_HTML_Elements.canvas([ Halogen_HTML_Properties.id("canvas"), Halogen_HTML_Properties.style("position: absolute;" + ("width: " + (Data_Show.show(Data_Show.showInt)(windowSize.width) + ("px; height: " + (Data_Show.show(Data_Show.showInt)(windowSize.height) + "px;"))))), Halogen_HTML_Properties.width(Data_Int.floor(Data_Int.toNumber(windowSize.width) * 1.0)), Halogen_HTML_Properties.height(Data_Int.floor(Data_Int.toNumber(windowSize.height) * 1.0)) ]), Halogen_HTML_Elements.i([ css("fas fa-camera"), Halogen_HTML_Properties.style("right: 40px; bottom: 10px; font-size: 20px; position: absolute; cursor: pointer; width: 50px; height: 50px; display: flex; align-items: center; justify-content: center;"), Halogen_HTML_Events.onClick(function (v5) {
                                  return Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(Effect_Aff.monadEffectAff))(function __do() {
                                      var canvas = Control_Bind.bindFlipped(Effect.bindEffect)(Data_Maybe.maybe(Effect_Exception["throw"]("canvas\u8981\u7d20\u304c\u53d6\u5f97\u3067\u304d\u307e\u305b\u3093\u3067\u3057\u305f"))(Control_Applicative.pure(Effect.applicativeEffect)))(Graphics_Canvas.getCanvasElementById("canvas"))();
                                      return $foreign.shoot(canvas)();
                                  });
                              }) ])([  ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("right: 40px; top: 10px; font-size: 15px; font-family: 'Montserrat', sans-serif; position: absolute; width: auto; height: 50px; display: flex; align-items: center; justify-content: center;") ])([ Halogen_HTML_Core.text("YUKIWORKS"), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("https://yukikurage.github.io/portfolio/"), Halogen_HTML_Properties.style("position:absolute; width: 100%; height: 100%; left: 0; top: 0;"), Halogen_HTML_Properties.target("_blank"), Halogen_HTML_Properties.rel("noopener") ])([  ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("left: 40px; top: 10px; font-size: 20px; font-family: 'Montserrat', sans-serif; position: absolute; width: auto; height: 50px; display: flex; align-items: center; justify-content: center;") ])([ Halogen_HTML_Core.text("MANDELBROT") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("left: 40px; bottom: 10px; font-size: 20px; position: absolute; height: auto; margin: 10px 10px 10px 10px; display: flex; flex-direction: column; font-family: 'Montserrat', sans-serif; font-size: 15px;") ])([ makeColorSetter($foreign.setColorInner)("#ffffff")("Inside :")(v2.value1)(v2.value0), makeColorSetter($foreign.setColorOuterZero)("#ffffff")("Outside Zero :")(v3.value1)(v3.value0), makeColorSetter($foreign.setColorOuterMax)("#000000")("Outside Max :")(v4.value1)(v4.value0), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("display: flex; flex-direction: row; align-items: center; margin: 10px 10px 10px 0px;") ])([ Halogen_HTML_Core.text("Mix Mode:"), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputRadio.value), Halogen_HTML_Properties.value("hsv"), Halogen_HTML_Properties.name("colorModeRadio"), Halogen_HTML_Properties.id("colorModeRadioHSV"), Halogen_HTML_Properties.checked(true), Halogen_HTML_Properties.style("margin-left: 10px"), Halogen_HTML_Events.onChecked(function (b) {
                                  return Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(Effect_Aff.monadEffectAff))(Control_Applicative.when(Effect.applicativeEffect)(b)($foreign.changeColorMode(0)));
                              }) ]), Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"]("colorModeRadioHSV") ])([ Halogen_HTML_Core.text("HSV") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputRadio.value), Halogen_HTML_Properties.value("rgb"), Halogen_HTML_Properties.name("colorModeRadio"), Halogen_HTML_Properties.id("colorModeRadioRGB"), Halogen_HTML_Properties.style("margin-left: 10px"), Halogen_HTML_Events.onChecked(function (b) {
                                  return Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(Effect_Aff.monadEffectAff))(Control_Applicative.when(Effect.applicativeEffect)(b)($foreign.changeColorMode(1)));
                              }) ]), Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"]("colorModeRadioRGB") ])([ Halogen_HTML_Core.text("RGB") ]) ]) ]) ]));
                          });
                      });
                  });
              });
...
(function($PS) {
  ...
  var Mandelbrot_Mandelbrot = $PS["Mandelbrot.Mandelbrot"];                
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(Mandelbrot_Mandelbrot.component)(Data_Unit.unit)(body);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();