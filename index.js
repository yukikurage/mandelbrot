          ...
          return function (tex) {
              return function (id) {
                  return function (color) {
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("display: flex; flex-direction: row; align-items: center;") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("margin: 10px 10px 10px 10px; width: 18px; height: 18px; border: solid 1px #000000; background-color:" + (Color.toHexString(color) + ";")) ])([  ]), Halogen_HTML_Core.text(tex), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.style("margin: 10px 10px 10px 10px; inherit; background-color:rgba(255,255,255,0); border: 0px solid; font-family: 'Montserrat', sans-serif; font-size: 18px;"), Halogen_HTML_Properties.value(val), Halogen_HTML_Events.onInput(function (e) {
