...
(function($PS) {
  ...
  var Data_Maybe = $PS["Data.Maybe"];
  var Effect = $PS["Effect"];
  var typedArrayUint8Clamped = {
      create: $foreign.newUint8ClampedArray,
      ...
      return function (a) {
          return function (mo) {
              return function (b) {
                  ...
                  var $63 = o >= 0 && lenfn(b) <= (length(a) - o | 0);
                  if ($63) {
  ...
  exports["set"] = set;
  exports["typedArrayUint8Clamped"] = typedArrayUint8Clamped;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
...
(function($PS) {
  ...
  var semiringComplex = function (dictRing) {
      return {
          add: function (v) {
              return function (v1) {
                  return new Complex(Data_Semiring.add(dictRing.Semiring0())(v.value0)(v1.value0), Data_Semiring.add(dictRing.Semiring0())(v.value1)(v1.value1));
              };
          },
          zero: new Complex(Data_Semiring.zero(dictRing.Semiring0()), Data_Semiring.zero(dictRing.Semiring0())),
          mul: function (v) {
              return function (v1) {
                  return new Complex(Data_Ring.sub(dictRing)(Data_Semiring.mul(dictRing.Semiring0())(v.value0)(v1.value0))(Data_Semiring.mul(dictRing.Semiring0())(v.value1)(v1.value1)), Data_Semiring.add(dictRing.Semiring0())(Data_Semiring.mul(dictRing.Semiring0())(v.value0)(v1.value1))(Data_Semiring.mul(dictRing.Semiring0())(v.value1)(v1.value0)));
              };
          },
          one: new Complex(Data_Semiring.one(dictRing.Semiring0()), Data_Semiring.zero(dictRing.Semiring0()))
      };
  };
  var real = function (v) {
      return v.value0;
  };
  var magnitude = function (dictSemiring) {
      return function (v) {
          return Data_Semiring.add(dictSemiring)(Data_Semiring.mul(dictSemiring)(v.value0)(v.value0))(Data_Semiring.mul(dictSemiring)(v.value1)(v.value1));
      };
  };
  var imag = function (v) {
      return v.value1;
...
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["Mandelbrot"] = $PS["Mandelbrot"] || {};
  var exports = $PS["Mandelbrot"];
  ...
  var Convergence = (function () {
      ...
      Convergence.value = new Convergence();
      return Convergence;
  })();
  var Divergence = (function () {
      function Divergence(value0) {
          this.value0 = value0;
      };
      Divergence.create = function (value0) {
          return new Divergence(value0);
      };
      return Divergence;
  })();
  var mandelbrot = function (n) {
      return function (c) {
          var rec = function (z) {
              return Data_Semiring.add(Data_Complex.semiringComplex(Data_Ring.ringNumber))(Data_Semiring.mul(Data_Complex.semiringComplex(Data_Ring.ringNumber))(z)(z))(c);
          };
          var itr = Data_List_Lazy.take(n)(Data_List_Lazy.iterate(rec)(new Data_Complex.Complex(0.0, 0.0)));
          var result = Data_List_Lazy.findIndex(function (w) {
              return Data_Complex.magnitude(Data_Semiring.semiringNumber)(w) > 2.0;
          })(itr);
          if (result instanceof Data_Maybe.Nothing) {
              return Convergence.value;
          };
          if (result instanceof Data_Maybe.Just) {
              return new Divergence(result.value0);
          };
          throw new Error("Failed pattern match at Mandelbrot (line 16, column 18 - line 18, column 25): " + [ result.constructor.name ]);
      };
  };
  exports["Convergence"] = Convergence;
...
(function($PS) {
  ...
  var Halogen_Hooks_Hook = $PS["Halogen.Hooks.Hook"];
  var Halogen_Hooks_HookM = $PS["Halogen.Hooks.HookM"];
  var Mandelbrot = $PS["Mandelbrot"];                
  var initialRange = {
      bottomLeft: new Data_Complex.Complex(-2.0, -2.0),
      topRight: new Data_Complex.Complex(2.0, 2.0)
  };
  var component = Halogen_Hooks_Component.component(function (v) {
      return function (v1) {
          return Halogen_Hooks_Hook.discard(Halogen_Hooks.useLifecycleEffect(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(Effect_Aff.monadEffectAff))(function __do() {
              ...
              var imageData = Graphics_Canvas.getImageData(context)(0.0)(0.0)(width)(height)();
              var pixels = Graphics_Canvas.imageDataBuffer(imageData);
              var imgWidth = Graphics_Canvas.imageDataWidth(imageData);
              var imgHeight = Graphics_Canvas.imageDataHeight(imageData);
              Data_ArrayBuffer_Typed.set(Data_ArrayBuffer_Typed.typedArrayUint8Clamped)(pixels)(Data_Maybe.Nothing.value)(Data_Array.concat(Control_Bind.bind(Control_Bind.bindArray)(Data_Array.range(0)(imgHeight - 1 | 0))(function (y) {
                  return Control_Bind.bind(Control_Bind.bindArray)(Data_Array.range(0)(imgWidth - 1 | 0))(function (x) {
                      var z = new Data_Complex.Complex(Data_Complex.real(initialRange.bottomLeft) + ((Data_Complex.real(initialRange.topRight) - Data_Complex.real(initialRange.bottomLeft)) * Data_Int.toNumber(x)) / Data_Int.toNumber(imgWidth), Data_Complex.imag(initialRange.topRight) - ((Data_Complex.imag(initialRange.topRight) - Data_Complex.imag(initialRange.bottomLeft)) * Data_Int.toNumber(y)) / Data_Int.toNumber(imgHeight));
                      return Control_Applicative.pure(Control_Applicative.applicativeArray)(Data_Functor.map(Data_Functor.functorArray)(Data_UInt.fromInt)((function () {
                          var v2 = Mandelbrot.mandelbrot(50)(z);
                          if (v2 instanceof Mandelbrot.Convergence) {
                              return [ 0, 0, 0, 255 ];
                          };
                          if (v2 instanceof Mandelbrot.Divergence) {
                              return [ 255, 255, 255, 255 ];
                          };
                          throw new Error("Failed pattern match at Viewer (line 46, column 30 - line 48, column 47): " + [ v2.constructor.name ]);
                      })()));
                  });
              })))();
              Graphics_Canvas.putImageData(context)(imageData)(0.0)(0.0)();
              return Data_Unit.unit;
          }))(function () {
              return Control_Applicative.pure(Halogen_Hooks_HookM.applicativeHookM)(Data_Maybe.Nothing.value);
          })))(function () {
              return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.canvas([ Halogen_HTML_Properties.id("canvas"), Halogen_HTML_Properties.width(640), Halogen_HTML_Properties.height(640) ]));
          });
      };
  });
  exports["component"] = component;
